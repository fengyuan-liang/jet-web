...
var UserAgent = "Golang Jet/rpc package"

const defaultTimestampFormat = "2006-01-02 15:04:05.999999"

// --------------------------------------------------------------------

// Client a golang httputil client
type Client struct {
	*http.Client
	Header http.Header
}

// DefaultClient a golang default httputil client
var DefaultClient = Client{
	Client: &http.Client{Transport: DefaultTransport},
}

// NewClientTimeout return a golang httputil client
...
// HTTPCode return rpc httputil StatusCode
...
// CallRet parse httputil response
