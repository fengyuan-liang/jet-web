...
func logWithReqid(lvl int, reqid string, str string) {
	...
	xlog.Std.Output(reqid, xlog.Lwarn, lvl+1, str)
}
...
// deprecated: use httputil.Request.Context()
...
// deprecated: use httputil.Request.WithContext()
